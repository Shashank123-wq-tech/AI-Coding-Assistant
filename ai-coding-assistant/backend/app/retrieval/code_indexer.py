...
class CodeIndexer:
    ...
    def _index_python_file(
        ...
        """
        Index a complete Python source file.

        A Python file is currently represented as one chunk.
        Function/class-level chunking can be added later.
        """
        ...
        if analysis["error"] is not None:
            metadata["syntax_error"] = analysis[
                "error"
            ]
    ...
    def _index_notebook(
        ...
        """
        Index a Jupyter notebook cell-by-cell.

        Code cells are validated using PythonASTParser.

        Markdown and raw cells are indexed as text.
        """
        ...
        for cell in notebook["cells"]:
            ...
            if cell_type == "code":
                ...
                analysis = (
                    self.python_parser.analyze_source(
                        content
                    )
                )
            ...
            # Preserve notebook execution information
            # for code cells.
